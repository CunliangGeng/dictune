...
export const UI_STRINGS: Record<LangCode, UIStrings> = {
  en: {
    ...
    dictation: "Dictation",
    placeholder: "Start your system dictation and speak the original text...",
    compare: "Compare",
    tryAgain: "Try Again",
    ...
    reload: "Reload",
    tagline: "Pronunciation clarity practice",
    ...
    generatingText: "Generating practice text...",
  },
  nl: {
    generate: "Genereer",
    ...
    dictation: "Dictaat",
    placeholder: "Start systeemdicteren en spreek de originele tekst uit...",
    compare: "Vergelijk",
    tryAgain: "Opnieuw",
    ...
    reload: "Herladen",
    tagline: "Oefentool voor uitspraak",
    ...
    generatingText: "Oefentekst genereren...",
  },
  zh: {
    generate: "生成",
    generating: "生成中...",
